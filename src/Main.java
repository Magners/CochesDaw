...
/*1. Implementa las clases RegistroVehículos y la clase Taller para superar con éxito sus respectivos juegos de pruebas (las clases Main correspondientes).
2. Comprueba que la ordenación de las personas en el método obtenerClientes se ajusta al comparador especificado en la construcción del TreeMap (es decir, haz las pruebas especificando diversos getters de la clase Persona).
*/
public class Main {
